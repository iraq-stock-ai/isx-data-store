...
prompt = "أنت خبير في تحليل صفحات سوق العراق للأوراق المالية. هذا محتوى الصفحة: " + html_content[:15000] + "\nالمطلوب: استخرج أحدث الإفصاحات (عنوان ورابط). أرجع JSON فقط كقائمة: [{\"title\": \"...\", \"url\": \"...\"}]. إذا لا يوجد جديد أرجع []."
