...
# ⬅️ التعديل المطلوب هنا: القيمة 50 (بدل الافتراضي الأصلي 15).
# هذا الرقم هو "عدد محاولات storyId الفارغة المتتالية المسموحة قبل
# الاستسلام الكامل بالبحث عن العنصر الحالي بـ find_next_new_item()"،
# وليس عدد العناصر أو عدد التشغيلات الكلي. بمعنى: لو صادف السكربت
# 50 رقم storyId فارغ متتالي دون أي نجاح، يتوقف عن هذه المحاولة
# ويرجع None — وبما أن last_known_story_id لا يتقدّم إلا عند نجاح
# فعلي (راجع process_one_item/main)، فإن نفس النطاق الفاضي يُعاد
# فحصه بالكامل تلقائياً بالتشغيلة القادمة، دون فقدان أي رقم نهائياً.
MAX_GAP_ATTEMPTS = 50
